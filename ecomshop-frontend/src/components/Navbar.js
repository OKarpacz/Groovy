...
const Navbar = () => (
    <nav className="sticky top-0 z-50 bg-yellow-200 py-4 px-8 flex justify-between items-center shadow-md rounded-b-lg">
        ...
        <div className="flex space-x-6">
            <Link to="/" className="text-orange-700 hover:text-orange-900 font-bold">
                <img
            ...
            <Link to="/faq" className="text-orange-700 hover:text-orange-900 font-bold">
                <img
            ...
            <Link to="/top-charts" className= "text-orange-700 hover:text-orange-900 font-bold">
                <img
            ...
            <Link to="/cart" className="text-orange-700 hover:text-orange-900 font-bold">
                <img
